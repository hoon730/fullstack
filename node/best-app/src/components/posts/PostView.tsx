...
const PostView:React.FC=()=>{
    ...
    const handleDelete =async ()=>{
        ...
        if(result){
            ...
            alert('삭제 실패 - 해당 글이 존재하지 않아요 ')
        }
        //////////////
    }
    
    if(!post) return <div className="text-parimary text-center">Loading...</div>
      ...
      <div className="card">
        <div className="card-body">
          ...
          <div style={{ marginBottom: '1rem' }} className="text-center">
            <img
              src={post.file?`http://localhost:7777/uploads/${post.file}`
          ...
          <div className="cArea px-5">
            {post.content}
            <br />
           <FaRegHeart style={{ color: 'hotpink' }} />
