...
export default function ChatApp(){
    ...
    useEffect(()=>{
        ...
        return ()=>{ //unmount될때 실행되는 cleanup 함수
            if(socket.connected){
    ...
    if(isLoading || !authUser){
        return (
            <div className="alert alert-primary">
                <h2><IoChatboxEllipsesOutline/> 실시간 채팅</h2>
    ...
    return (
        <div className="wrap">
            ...
            <input name="message" ref={messageRef}
             ...
             />
            <button className="btn btn-info mx-1" onClick={sendMessage}>Send</button>
        </div>
    )
}